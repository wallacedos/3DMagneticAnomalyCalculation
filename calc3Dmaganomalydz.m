function deltaTdz = calc3Dmaganomalydz(Grid,Mpt,I,I0,A,A0)
...
%   respect to the derivative of z of each block.
%
...
%
%  OUT  deltaTdy: the total  magnetic field anomaly with respect to the 
%                 derivative of z.
%
...
for i=1:N
    ...
    for j=1:M
        ...
        deltaTdz_sub=mu0/(4*pi)*MagI(rowind,colind,kind)*calcGmagdzelement(coeff,ulbound);
        deltaTdz(i)=deltaTdz(i)+deltaTdz_sub;
    end
end
deltaTdz=reshape(deltaTdz,m1,n1)*10^(9);
end
