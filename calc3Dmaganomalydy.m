function deltaTdy = calc3Dmaganomalydy(Grid,Mpt,I,I0,A,A0)
...
%   respect to the derivative of y of each block.
%
...
for i=1:N
    ...
    for j=1:M
        ...
        deltaTdy_sub=mu0/(4*pi)*MagI(rowind,colind,kind)*calcGmagdyelement(coeff,ulbound);
        deltaTdy(i)=deltaTdy(i)+deltaTdy_sub;
    end
end
deltaTdy=reshape(deltaTdy,m1,n1)*10^(9);
end
